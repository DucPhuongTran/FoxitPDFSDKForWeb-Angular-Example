...
declare namespace PDF {
  ...
  namespace actions {
    ...
    export import ActionSpecWithTrigger = __internal__.ActionSpecWithTrigger;

    export import AdditionalAction = __internal__.AdditionalAction;

    export import EmbeddedGotoAction = __internal__.EmbeddedGotoAction;

    export import EmbeddedGotoActionData = __internal__.EmbeddedGotoActionData;

    export import EmbeddedGotoTargetData = __internal__.EmbeddedGotoTargetData;

    export import EmbeddedGotoTargetFileInfo = __internal__.EmbeddedGotoTargetFileInfo;

    export import FileSpecData = __internal__.FileSpecData;

    export import GoToAction = __internal__.GoToAction;

    export import GotoActionData = __internal__.GotoActionData;

    export import HideAction = __internal__.HideAction;

    export import HideActionData = __internal__.HideActionData;

    export import ImportDataActionData = __internal__.ImportDataActionData;

    export import JavaScriptAction = __internal__.JavaScriptAction;

    export import JavaScriptActionData = __internal__.JavaScriptActionData;

    export import LaunchAction = __internal__.LaunchAction;

    export import LaunchActionData = __internal__.LaunchActionData;

    export import RemoteGotoAction = __internal__.RemoteGotoAction;

    export import RemoteGotoActionData = __internal__.RemoteGotoActionData;

    export import ResetFormAction = __internal__.ResetFormAction;

    export import ResetFormActionData = __internal__.ResetFormActionData;

    export import SubmitFormAction = __internal__.SubmitFormAction;

    export import SubmitFormActionData = __internal__.SubmitFormActionData;

    export import URIAction = __internal__.URIAction;

    export import URIActionData = __internal__.URIActionData;

    export import ZoomFitBBoxDestinationData = __internal__.ZoomFitBBoxDestinationData;

    export import ZoomFitBHorzDestinationData = __internal__.ZoomFitBHorzDestinationData;

    export import ZoomFitBVertDestinationData = __internal__.ZoomFitBVertDestinationData;

    export import ZoomFitHorzDestinationData = __internal__.ZoomFitHorzDestinationData;

    export import ZoomFitPageDestinationData = __internal__.ZoomFitPageDestinationData;

    export import ZoomFitRectDestinationData = __internal__.ZoomFitRectDestinationData;

    export import ZoomFitVertDestinationData = __internal__.ZoomFitVertDestinationData;

    export import ZoomXYZDestinationData = __internal__.ZoomXYZDestinationData;

    export import ActionTriggerEvents = __internal__.ActionTriggerEvents;

    export import ActionType = __internal__.ActionType;

    export import EmbeddedGotoTargetRelationship = __internal__.EmbeddedGotoTargetRelationship;

    export import NewWindowFlag = __internal__.NewWindowFlag;

    export import ZoomMode = __internal__.ZoomMode;

    export import ActionData = __internal__.ActionData;

    export import ActionHierarchy = __internal__.ActionHierarchy;

    export import ActionSpecification = __internal__.ActionSpecification;

    export import AnnotActionTriggerEvents = __internal__.AnnotActionTriggerEvents;

    export import DestinationData = __internal__.DestinationData;

    export import DocActionTriggerEvents = __internal__.DocActionTriggerEvents;

    export import FieldActionTriggerEvents = __internal__.FieldActionTriggerEvents;

    export import PageActionTriggerEvents = __internal__.PageActionTriggerEvents;
  }
  ...
  namespace annots {
    ...
    export import HighlightingMode = __internal__.HighlightingMode;
  }

  namespace common {
    export import AnnotId = __internal__.AnnotId;

    export import AnnotQuery = __internal__.AnnotQuery;

    export import BookmarkQuery = __internal__.BookmarkQuery;

    export import DocQuery = __internal__.DocQuery;

    export import FileSpec = __internal__.FileSpec;

    export import FormFieldQuery = __internal__.FormFieldQuery;

    export import PageQuery = __internal__.PageQuery;

    export import PDFObjectQuery = __internal__.PDFObjectQuery;
  }
  ...
  namespace constant {
    ...
    export import PageLayout = __internal__.PageLayout;

    export import PageMode = __internal__.PageMode;
    ...
    export import RemoveHiddenDataTypes = __internal__.RemoveHiddenDataTypes;
  ...
  namespace form {
    namespace constant {
      ...
      export import FieldCalculateType = __internal__.FieldCalculateType;

      export import FieldFlag = __internal__.FieldFlag;

      export import FieldType = __internal__.FieldType;

      export import FormatCategory = __internal__.FormatCategory;

      export import FormWidgetRotation = __internal__.FormWidgetRotation;

      export import MDPActionType = __internal__.MDPActionType;

      export import Signature_Type = __internal__.Signature_Type;

      export import SpecialFormatEnum = __internal__.SpecialFormatEnum;

      export import TimeFormatEnum = __internal__.TimeFormatEnum;

      export import ValidateTypeEnum = __internal__.ValidateTypeEnum;
    }

    export import ChoiceOptionItem = __internal__.ChoiceOptionItem;

    export import CloneWidgetOptions = __internal__.CloneWidgetOptions;

    export import CustomAppearance = __internal__.CustomAppearance;

    export import DefaultAppearance = __internal__.DefaultAppearance;

    export import DefaultAppearanceFontInfo = __internal__.DefaultAppearanceFontInfo;

    export import ExportFormOptions = __internal__.ExportFormOptions;

    export import ExtFieldType = __internal__.ExtFieldType;

    export import FieldFlagOptions = __internal__.FieldFlagOptions;

    export import FormInputEvent = __internal__.FormInputEvent;

    export import FormInteractionEvent = __internal__.FormInteractionEvent;

    export import FormInteractionEventFlags = __internal__.FormInteractionEventFlags;

    export import FormInteractionEventInterceptorOptions = __internal__.FormInteractionEventInterceptorOptions;

    export import FormKeyboardEvent = __internal__.FormKeyboardEvent;

    export import FormMouseEvent = __internal__.FormMouseEvent;

    export import FormMouseWheelEvent = __internal__.FormMouseWheelEvent;

    export import FormPasteEvent = __internal__.FormPasteEvent;

    export import IFormSignatureField = __internal__.IFormSignatureField;

    export import ImportFormFromCSVOptions = __internal__.ImportFormFromCSVOptions;

    export import ImportFormOptions = __internal__.ImportFormOptions;

    export import IncludeExcludeMDPActionData = __internal__.IncludeExcludeMDPActionData;

    export import ISignatureField = __internal__.ISignatureField;

    export import IXFASignatureField = __internal__.IXFASignatureField;

    export import MKCaptionOptions = __internal__.MKCaptionOptions;

    export import MKIconBitmap = __internal__.MKIconBitmap;

    export import MKIconFitOptions = __internal__.MKIconFitOptions;

    export import MKIconOptions = __internal__.MKIconOptions;

    export import MoveActionOptions = __internal__.MoveActionOptions;

    export import PagingSealConfig = __internal__.PagingSealConfig;

    export import PDFForm = __internal__.PDFForm;

    export import PDFFormField = __internal__.PDFFormField;

    export import PDFSignature = __internal__.PDFSignature;

    export import SignatureAppearanceInfo = __internal__.SignatureAppearanceInfo;

    export import SignatureService = __internal__.SignatureService;

    export import SignatureStyleConfig = __internal__.SignatureStyleConfig;

    export import SignatureVerificationOptions = __internal__.SignatureVerificationOptions;

    export import SignatureWorkflowService = __internal__.SignatureWorkflowService;

    export import SignDocInfo = __internal__.SignDocInfo;

    export import SignedFormSignatureInfo = __internal__.SignedFormSignatureInfo;

    export import SignedXFASignatureInfo = __internal__.SignedXFASignatureInfo;

    export import SignerInfo = __internal__.SignerInfo;

    export import SigningSettings = __internal__.SigningSettings;

    export import SigningTimeFormat = __internal__.SigningTimeFormat;

    export import SigningTimeFormatTimeZoneOptions = __internal__.SigningTimeFormatTimeZoneOptions;

    export import UnsignedFormSignatureInfo = __internal__.UnsignedFormSignatureInfo;

    export import UnsignedXFASignatureInfo = __internal__.UnsignedXFASignatureInfo;

    export import DefAPFlags = __internal__.DefAPFlags;

    export import FormFieldPropertyName = __internal__.FormFieldPropertyName;

    export import FormMouseEventButtonType = __internal__.FormMouseEventButtonType;

    export import FormWidgetDirection = __internal__.FormWidgetDirection;

    export import PagingSealPosition = __internal__.PagingSealPosition;

    export import ScaleWayType = __internal__.ScaleWayType;

    export import SignatureType = __internal__.SignatureType;

    export import TextWidgetAlignment = __internal__.TextWidgetAlignment;

    export import WidgetGestureState = __internal__.WidgetGestureState;

    export import WidgetIconCaptionRelation = __internal__.WidgetIconCaptionRelation;

    export import DigestSignHandler = __internal__.DigestSignHandler;

    export import EventType = __internal__.EventType;

    export import FormInteractionEventInterceptor = __internal__.FormInteractionEventInterceptor;

    export import FormSignatureInfo = __internal__.FormSignatureInfo;

    export import SignatureInfo = __internal__.SignatureInfo;

    export import SignerOverridePolicy = __internal__.SignerOverridePolicy;

    export import SigningWorkflowHandler = __internal__.SigningWorkflowHandler;

    export import VerifySignatureHandler = __internal__.VerifySignatureHandler;

    export import VerifyWorkflowHandler = __internal__.VerifyWorkflowHandler;

    export import XFASignatureInfo = __internal__.XFASignatureInfo;
  }
  ...
  export import ExportFileProgress = __internal__.ExportFileProgress;
  ...
  export import PDFViewPreference = __internal__.PDFViewPreference;

  export import TextObject = __internal__.TextObject;
}

declare namespace actions {
  export import ExecuteActionData = __internal__.ExecuteActionData;

  export import ExecuteActionOptions = __internal__.ExecuteActionOptions;
}
...
declare namespace commons {
  export import PDFDate = __internal__.PDFDate;

  export import Rect = __internal__.Rect;

  export import FileFormat = __internal__.FileFormat;
}
...
declare namespace form {
  export import BasicCreateWidgetOptions = __internal__.BasicCreateWidgetOptions;

  export import CreateCheckBoxOptions = __internal__.CreateCheckBoxOptions;

  export import CreateComboBoxOptions = __internal__.CreateComboBoxOptions;

  export import CreateDatetimeOptions = __internal__.CreateDatetimeOptions;

  export import CreateImageButtonOptions = __internal__.CreateImageButtonOptions;

  export import CreateListBoxOptions = __internal__.CreateListBoxOptions;

  export import CreatePushButtonOptions = __internal__.CreatePushButtonOptions;

  export import CreateRadioButtonOptions = __internal__.CreateRadioButtonOptions;

  export import CreateSignatureOptions = __internal__.CreateSignatureOptions;

  export import CreateTextFieldOptions = __internal__.CreateTextFieldOptions;

  export import FormFillerService = __internal__.FormFillerService;

  export import FormDesignMode = __internal__.FormDesignMode;
}
...
declare namespace constants {
  ...
  export import DIRECTION = __internal__.DIRECTION;
...
declare namespace annotCompontents {
  ...
  export import SignatureAnnot = __internal__.SignatureAnnot;
}
...
declare namespace viewerui {
  ...
  export import IDateTimePicker = __internal__.IDateTimePicker;

  export import IFloatingTooltip = __internal__.IFloatingTooltip;

  export import ISignatureUI = __internal__.ISignatureUI;

  export import ISignDocDialog = __internal__.ISignDocDialog;

  export import ISignedSignaturePropertiesDialog = __internal__.ISignedSignaturePropertiesDialog;

  export import ISignVerifiedResultDialog = __internal__.ISignVerifiedResultDialog;

  export import IViewerUI = __internal__.IViewerUI;

  export import OpenDateTimePickerOption = __internal__.OpenDateTimePickerOption;

  export import TinyViewerUI = __internal__.TinyViewerUI;

  export import XFAWidgetInfo = __internal__.XFAWidgetInfo;
}
