...
declare module __internal__ {
  ...
  export interface SignatureAppearanceInfo {
  ...
  class SignatureWorkflowService {
    addSignatureAPInfo(style: SignatureAppearanceInfo): void;
    addSignerInfo(signerInfo: SignerInfo): void;
    getSignatureAPInfoList(): SignatureAppearanceInfo[];
    getSignatureAPStyle(): SignatureStyleConfig;
    getSignerInfoList(): SignerInfo[];
    ...
    setSignatureAPStyle(style: SignatureStyleConfig): void;
  ...
  class PDFPage extends Disposable {
    addAnnot(annotJson: {
      type: Annot_Type;
      rect: {
        left: number;
    ...
    getAnnotCountAsync(): Promise<number>;
  ...
  enum ViewerEvents {
    ...
    activeElementChanged = 'active-element-changed',
  ...
  export interface AnnotComponentConfig {
    ...
    enableFrame: boolean;
    enablePointsOrVertexes: boolean;
    moveable: boolean;
  ...
  class PDFViewer extends Disposable {
    constructor(options: {
      ...
      enableRealtimeAnnotShapeUpdate?: boolean;
      customs?: {
    ...
    setAnnotTabStrategy(strategy: number | boolean): void;
